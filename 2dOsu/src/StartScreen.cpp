...
StartScreen::StartScreen() {
	...
	button[START] = new Button("assets/button_start.png", 0, 550);
	...
	button[OPTION] = new Button("assets/button_option.png", 0, 610);
	button[OPTION]->focusButton = Texture::loadTexture("assets/button_option_focus.png");
	button[OPTION]->center(WIDTH / 2);

	button[EXIT] = new Button("assets/button_exit.png", 0, 670);
